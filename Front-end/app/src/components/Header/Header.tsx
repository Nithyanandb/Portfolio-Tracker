            ...
            <div className="flex items-center gap-4">
              {isAuthenticated ? (
                  ...
                  <AnimatePresence>
                    {isUserMenuOpen && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        className="absolute right-0 mt-2 w-48 py-2 bg-black/90 backdrop-blur-xl border border-white/10 rounded-lg shadow-xl"
                      >
                ...
                <motion.button
                  ...
                  className="px-6 py-2 bg-white text-black tracking-[0.2em] text-sm font-light"
