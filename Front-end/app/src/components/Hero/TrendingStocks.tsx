        ...
        <div className="p-6 space-y-4">
          {trendingStocks.map((stock, index) => (
            <motion.div
              ...
              className="group flex items-center justify-between p-4 bg-black/40 backdrop-filter backdrop-blur-xl glass-card rounded-lg shadow-md transition-all duration-300"
            >
