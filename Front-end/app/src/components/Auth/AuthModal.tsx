        ...
        >
          ...
          <AnimatePresence>
            {(isAuthenticating || success) && (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl bg-black/40 backdrop-blur-2xl border border-white/10 p-8">
                  ...
                  <div className="relative z-10 text-center space-y-6">
                      ...
                      <motion.div className="space-y-6">
                        <div className="relative mx-auto w-20 h-20">
                          ...
                          <motion.div
                            ...
                            className="absolute inset-5 rounded-full bg-blue-500/20"
                          />
                        </div>
                        <div>
                          <h3 className="text-2xl font-light tracking-wide text-white">Authenticating</h3>
                          <p className="mt-2 text-sm text-white/60 tracking-wider">Establishing secure connection...</p>
                        </div>
                      </motion.div>
                    )}
                    ...
                    {success && (
                      ...
                      >
                        <motion.div 
                          className="mx-auto w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center"
                          animate={{ 
                            boxShadow: [
                        ...
                        <div>
                          <h3 className="text-2xl font-light tracking-wide text-white">Welcome Aboard</h3>
                          <p className="mt-2 text-sm text-white/60 tracking-wider">Authentication successful</p>
                        </div>
                      </motion.div>
                    )}
                  </div>
